...
export const Utilities = () => {
  return (
    <div className='util-container'>
        <h2>NFT UTILITIES AND FEATURES:</h2>
        <p>The BOOBS OF BITCOIN PFP Collection is the Exclusive NFT Collection for BOOBS OF BITCOIN Ecosystem and Enjoys a Range of Benifits for Both Holders and OG Minters.</p>
        <h3>Holder Utility & Benifits :</h3>
        ...
        <li>Airdrop : A Total of 2% Supply is Guaranteed as Airdrop for Holders and an Additional 3% are allocated as Bonuses to be won by BOBS Role Holders through Various Events.</li>
        <li>BOBS ROLE : PFP Holders get a Special Role called "BOBS". </li>

        <h3>Genesis Minter Benifits: </h3>
        ...
        <li>BOBS ROLE  : Genesis minting participants will be counted as a "BOBS" regardless if they Hold their PFP and will get to keep their role.</li>
    </div>
  )
}
