...
const TxtSlider = () => {
  ...
  return (
    <div className='bg-[#231F20] flex justify-between flex-col md:flex-row md:justify-between items-center h-[900px] overflow-x-auto md:pt-[2rem] pb-[2rem] border-b border-white'>
