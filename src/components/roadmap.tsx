  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "NFTs that change appearance based on market conditions",
        icon: Sparkles,
        completed: false,
      },
      {
        title: "Governance Token Launch",
        description: "Community-driven decision making and protocol upgrades",
        icon: Users,
        completed: false,
      },
      {
    ...
    items: [
      {
        ...
        description: "Enterprise-grade solutions for institutional investors",
        icon: Shield,
        completed: false,
      },
      {
        title: "Layer 2 Scaling",
        description: "Deploy on Bitcoin Layer 2 solutions for better scalability",
        icon: Zap,
        completed: false,
      },
      {
        title: "NFT Marketplace",
        description: "Dedicated marketplace for trading Bitcoin Bots",
        icon: Coins,
        completed: false,
      },
      {
        title: "Global Partnerships",
        description: "Strategic partnerships with major DeFi protocols",
        icon: Globe,
        completed: false,
      },
    ],
